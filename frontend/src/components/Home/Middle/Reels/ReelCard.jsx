...
export default function ReelCard() {
  ...
  return (
    <div className="relative w-80 mb-2">
      {state ? (
        <button
          className={` z-10 absolute p-2 top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-200`}
        >
      ...
      <div className="absolute left-2 bottom-4 flex gap-x-2">
        ...
        <Link to="/" className="text-white truncate w-24 inline-block pt-1">Billy Vasquez</Link>
      </div>
