...
export default function NotificationComponent() {
  return (
    <>
      <div className="w-80 py-1 px-3">
        <div className="flex justify-between pb-3">
          <div className="flex gap-x-3">
            <span className="font-bold">Notifications</span>
            <span className="bg-red-100 text-red-400 px-2 rounded-lg">
              4 new
            </span>
          </div>
          <span>clear all</span>
          ...
          <div className="flex gap-2 w-5/6">
            ...
            <div className="flex flex-col items-start gap-y-2">
              <p className="text-start text-sm">
                <strong>Judy Nguyan</strong> sent you a friend request
              </p>
              <div className="flex gap-x-2 text-sm">
                <button className="bg-blue-800 text-white py-1 px-2">
                  Accept
                </button>
                <button className="bg-red-100 text-red-500 py-1 px-2">
                  Delete
                </button>
              </div>
            </div>
        ...
        <div className="flex items-start mt-3 mb-2">
          <div className="flex gap-2 w-5/6">
            ...
            <div className="flex flex-col items-start gap-y-2">
              <p className="text-start text-sm">
                <strong>Judy Nguyan</strong> has 15 like and 1 activity
              </p>
            </div>
          </div>
...
<button className="bg-sky-100 text-sky-500 py-0.5 px-3 mt-4">
  <span>See all new activity</span>
</button>
