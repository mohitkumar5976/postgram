...
import Menu from "../Middle/Posts/Menu";
      ...
      <div className="card mb-2">
        <div className="card-body">
          <div className="flex flex-col gap-2">
                ...
                >
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex flex-col">
                      <Link className=" font-semibold truncate w-32">
                        Billy Vasquez
                      </Link>
            ...
            <p className="text-gray-400 pb-1 pt-2">
            ...
            <div className="cursor-pointer h-72">
              <img className="w-full h-full" src={`${data.postImage}`} />
            </div>
